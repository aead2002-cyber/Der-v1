...
import { incidentFeedbackApi } from '@/modules/der3/services/incidentFeedbackApi';
  ...
  return (
    <div className="p-6 space-y-8 max-w-[1600px] mx-auto" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <PageHeader
        ...
        description={isRtl ? 'إدارة ومتابعة البلاغات الأمنية المستلمة من النظام والجمهور' : 'Manage and monitor security incidents received from the system and public'}
        titleClassName="text-3xl font-black text-slate-900 tracking-tight"
        descriptionClassName="text-slate-500 font-medium mt-1"
        actions={
