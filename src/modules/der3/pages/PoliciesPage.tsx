...
export default function PoliciesPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={t('policies')}
        description={t('manage_policies_desc')}
        actions={
      ...
      <ConfirmDialog
        ...
        description={t('confirm_delete_policy_desc') || 'Are you sure you want to delete this policy? This action will remove all related standards and procedures.'}
