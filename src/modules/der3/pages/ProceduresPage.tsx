...
import { ProceduresImport } from '@/modules/der3/components/ProceduresImport';
import { ProcedureFormDialog } from '@/modules/der3/components/ProcedureFormDialog';
import { ProceduresAccordion } from '@/modules/der3/components/ProceduresAccordion';
...
export default function ProceduresPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={t('procedures')}
        description={t('manage_procedures_desc')}
        actions={
      ...
      <ConfirmDialog
        ...
        description={t('confirm_delete_procedure_desc') || 'Are you sure you want to delete this procedure? This action cannot be undone.'}
