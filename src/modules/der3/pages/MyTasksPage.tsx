...
import { auditLogsApi } from '@/modules/der3/services/auditLogsApi';
import { changeRequestsApi } from '@/modules/der3/services/changeRequestsApi';
...
import { incidentNotesApi } from '@/modules/der3/services/incidentNotesApi';
import { incidentsApi } from '@/modules/der3/services/incidentsApi';
import { lookupOptionsApi } from '@/modules/der3/services/lookupOptionsApi';
...
import { evidenceApi } from '@/modules/der3/services/evidenceApi';
...
import { SortableTableHead } from '@/modules/der3/components/SortableTableHead';
...
export default function MyTasksPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={
          <span className="flex items-center gap-2 text-3xl font-bold tracking-tight text-[#1e293b]">
            <ClipboardList className="w-8 h-8 text-blue-600" />
            {t('my_tasks')}
          </span>
        }
        description={isRtl ? 'قائمة بجميع الإجراءات والالتزامات المسندة إليك' : 'List of all procedures and commitments assigned to you'}
      />
      ...
      <ConfirmDialog
        open={isDeleteEvidenceConfirmOpen}
        onOpenChange={setIsDeleteEvidenceConfirmOpen}
        title={t('confirm_delete') || 'Confirm Delete'}
        description={isRtl ? 'هل أنت متأكد من رغبتك في حذف ملف الشاهد هذا؟ لا يمكن التراجع عن هذا الإجراء.' : 'Are you sure you want to delete this evidence file? This action cannot be undone.'}
