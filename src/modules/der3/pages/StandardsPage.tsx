...
import { StandardsImport } from '@/modules/der3/components/StandardsImport';
import { StandardFormDialog } from '@/modules/der3/components/StandardFormDialog';
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <PageHeader title={t('standards')} description={t('manage_standards_desc')} className="gap-0" />
      ...
      <ConfirmDialog
        ...
        description={t('confirm_delete_standard_desc') || 'Are you sure you want to delete this standard? This action cannot be undone.'}
      ...
      <ConfirmDialog
        open={isDeleteClassConfirmOpen}
        onOpenChange={setIsDeleteClassConfirmOpen}
        title={t('confirm_delete') || 'Confirm Delete'}
        description={t('confirm_delete_classification_desc') || 'Are you sure you want to delete this classification?'}
        confirmLabel={t('delete')}
        cancelLabel={t('cancel')}
