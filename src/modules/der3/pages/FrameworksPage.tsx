...
export default function FrameworksPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={t('frameworks')}
        description={t('manage_frameworks_desc')}
        actions={
      ...
      <ConfirmDialog
        ...
        description={t('confirm_delete_framework_desc') || 'Are you sure you want to delete this framework? This action will remove all related policies and standards.'}
