  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-text-main">{t('commitments') || 'Commitments & Licenses'}</h1>
          <p className="text-text-muted mt-1">{t('commitments_desc') || 'Manage regulatory licenses, certificates, and their expiry dates'}</p>
        </div>
        <Button 
        ...
        <DialogContent className="sm:max-w-[400px]">
          ...
          <div className="py-4">
            <p className="text-text-main font-medium">
              {t('confirm_delete_commitment_desc') || 'Are you sure you want to delete this commitment? This action cannot be undone.'}
            </p>
          </div>
